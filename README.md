...
- Dense exploration dashboard with a clustered satellite map, optional street/seamark layers, viewport and date-range filtering, a flat sortable dive table, and overlaid native SVG profiles with metadata tooltips
